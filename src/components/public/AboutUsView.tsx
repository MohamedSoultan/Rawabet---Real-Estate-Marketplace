...
export const AboutUsView: React.FC<AboutUsViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12 font-sans text-right">
      ...
      {/* Hero Section */}
      <section className="bg-[#001e00] text-white rounded-xl p-6 sm:p-12 border border-[#003a00] relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 max-w-3xl space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-[#002f00] text-[#14a800] border border-[#14a800]/30 text-xs font-black">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        <div className="p-5 sm:p-6 bg-white rounded-xl border border-[#e4ebe4] shadow-2xs space-y-1">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-xl border border-[#e4ebe4] shadow-2xs space-y-3">
            <div className="w-12 h-12 rounded-xl bg-[#f2f7f2] text-[#14a800] flex items-center justify-center">
      ...
      <section className="bg-[#f2f7f2] p-6 sm:p-8 rounded-xl border border-[#14a800]/20 flex flex-col md:flex-row items-center justify-between gap-6">
